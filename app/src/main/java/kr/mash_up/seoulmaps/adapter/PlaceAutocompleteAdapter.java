...
public class PlaceAutocompleteAdapter extends RecyclerView.Adapter<PlaceViewHolder> implements Filterable {
    ...
    public PlaceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.place_autocomplete_item, parent, false);
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        AutocompletePrediction placeItem = getItem(position);

        holder.placeTitle.setText(placeItem.getPrimaryText(STYLE_BOLD));
